...
/// Shows <see cref="Loading"/> while the query is <c>Idle</c> or <c>Fetching</c> (including background
/// re-fetches), <see cref="Content"/> on success, and <see cref="Failure"/> on error.
/// </summary>
/// <remarks>
